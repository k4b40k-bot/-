...
<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"{width}\" height=\"{height}\" viewBox=\"0 0 {width} {height}\">
  ...
  <text x=\"{width / 2}\" y=\"{padding / 2}\" text-anchor=\"middle\" font-size=\"16\">MAC-2 Acoustic Waveform (Direct Fluid Wave)</text>
...
def main() -> None:
    ...
    times, rx1_signal, rx2_signal = model_signals(geometry, medium, source, simulation)
